...
if __name__ == '__main__':
    dataset_name = 'msrs'
    ir_dir = os.path.join('/mlx_devbox/users/wangminglei.04/playground/image_fusion/dataset/msrs/test', 'ir')
    vi_dir = os.path.join('/mlx_devbox/users/wangminglei.04/playground/image_fusion/dataset/msrs/test', 'vi')
    Method = 'cddfusion'
    f_dir = os.path.join('/mlx_devbox/users/wangminglei.04/playground/image_fusion/results', dataset_name, Method)
    save_dir = 'Results/'
